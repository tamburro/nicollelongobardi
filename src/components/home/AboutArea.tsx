...
const counter_data = [
  { id: 1, title: 'Anos de Experiência', count: 10, cls: 'plus' },
  { id: 2, title: 'Grandes Eventos', count: 18, cls: 'plus' },
  { id: 3, title: 'Projetos 3º Setor', count: 15, cls: 'plus' },
]
            ...
            <div className="col-lg-9 col-sm-9">
              <div className="about-content-part wow fadeInUp delay-0-2s">
                <p>
                  ...
                  Tenho experiência em Gestão de Projetos, Planejamento Estratégico, Produção de Eventos Corporativos,
                  Produção Audiovisual, Produção Teatral e Direção Criativa no 3º setor.
