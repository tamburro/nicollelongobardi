          ...
          <div className="row">
            <div className="col-lg-6 col-md-6">
              <div className="testimonial-item wow fadeInUp delay-0-2s">
                ...
                <div className="text">
                  Gestão de eventos e projetos end-to-end: briefings, cronogramas, planilhas financeiras, logística, acompanhamento de execução e relatórios de fechamento.
                </div>
            ...
            <div className="col-lg-6 col-md-6">
              <div className="testimonial-item wow fadeInUp delay-0-4s">
                ...
                <div className="text">
                  Atendimento ao cliente, briefings, cotações, cronogramas e entrega de eventos para clientes como Grupo Soma, Hering, Animale, OAB e Transfero.
                </div>
                <div className="testi-des">
                  <h5>D+Live</h5>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="testimonial-item wow fadeInUp delay-0-8s">
                ...
                <div className="text">
                  7 anos de coordenação educacional, criação de oficinas teatrais, gestão de projetos artísticos e atuação profissional nas peças Dama In Vitro, Sala Cinza e O que não posso calar.
                </div>
                <div className="testi-des">
                  <h5>Coletivo Mundé</h5>
