              ...
              <div className="postbox__wrapper">
                <article className="postbox__item format-image mb-50 transition-3">
                  ...
                  <div className="postbox__content">
                    ...
                    <h3 className="postbox__title">
                      <Link href="/blog-details">Create a Landing Page That Performs Great</Link>
                    </h3>
                ...
                <article className="postbox__item format-video mb-50 transition-3">
                  ...
                  <div className="postbox__content">
                    ...
                    <h3 className="postbox__title">
                      <Link href="/blog-details">Starting and Growing a Career in Web Design</Link>
                    </h3>
                    <div className="postbox__text">
                      <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat […]</p>
                    </div>
                ...
                <article className="postbox__item format-audio mb-50 transition-3">
                  ...
                  <div className="postbox__content">
                    ...
                    <h3 className="postbox__title">
                      <Link href="/blog-details">How Can Designers Prepare for the Future?</Link>
                    </h3>
                    <div className="postbox__text">
                      <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat […]</p>
                    </div>
                ...
                <article className="postbox__item format-image mb-50 transition-3">
                  ...
                  <div className="postbox__content">
                    ...
                    <h3 className="postbox__title">
                      <Link href="/blog-details">Visiting the Ads of the World blog is like visiting museum</Link>
                    </h3>
                    <div className="postbox__text">
                      <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat […]</p>
                    </div>
                ...
                <div className="tp-pagination mt-20">
                  <nav>
                    <ul>
                      <li>
                        <Link href="/blog" className="tp-pagination-prev prev page-numbers">
            ...
            <div className="col-xxl-4 col-lg-4">
              <div className="blog_sidebar__wrapper pl-40">
                ...
                <div className="sidebar__widget mb-45">
                  ...
                  <div className="sidebar__widget-content">
                    <ul>
                      <li><Link href="/blog">Design Media <span>10</span></Link></li>
                      <li><Link href="/blog">Figma Design <span>08</span></Link></li>
                      <li><Link href="/blog">Web Design <span>24</span></Link></li>
                      <li><Link href="/blog">Wix Development <span>37</span></Link></li>
                      <li><Link href="/blog">Framer Website <span>103</span></Link></li>
                    </ul>
                  </div>
                </div>
